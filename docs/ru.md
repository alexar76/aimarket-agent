...
- [Политика версионирования SDK](https://github.com/alexar76/aicom/blob/main/docs/sdk-version-policy.md) — почему Python имеет версию 2.x, а остальные — 0.1.x
