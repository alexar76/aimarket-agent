...
- [Política de versionado de los SDKs](https://github.com/alexar76/aicom/blob/main/docs/sdk-version-policy.md) — por qué Python es 2.x y los demás son 0.1.x
